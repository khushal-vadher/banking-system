<?php
    ...
    if (isset($_POST['addemp'])) {
        ...
        $query = "INSERT INTO `employeedata` (`first_name`, `father_name`, `last_name`, `email_address`, `pass`, `mobile_no`, `aadhar_no`, `emp_id`, `dob`, `qualification`, `address`, `city`, `taluka`, `district`, `state`) VALUES ('$firstname', '$fathername', '$lastname', '$email', '$password', '$mobile', '$aadhar_no', '$employee_id', '$dob', '$qualification', '$address', '$city', '$taluka', '$district', '$state')";
        ...
        <div class="row" >
            ...
            <div id="main-id" class="col-sm-5">
                <div class="mt-3" id="heading">
                    <center>
                        <h4><b>PHP Bank Employee ID </b></h4>
                    </center>
                </div>
